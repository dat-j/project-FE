...
| Timezone | GMT+7              |
| E-mail   | tranxuandat.dev@gmail.com  |
...
If you want to find me on social media, just search for **@dat-j**. That's my username on almost all platforms, so it should be easy to find me.
